...
module.exports = function (message, topicARN, minsElapsed, context) {
    ...
    var publishMonitorMessage = function(job, deployment, topicARN, callback) {
    ...
    var deployOpsworks = function(job, actionConfig, topicARN, callback) {
        getLayerInstances(job, actionConfig['OpsWorks-Stack-ID'], function(instances) {
            opsworks.createDeployment({
                ...
                publishMonitorMessage(job, data, topicARN, callback);
            });
        });
    }
    ...
    var dispatchJob = function (job, callback) {
        ...
        async.series([
                ...
                function (callback) {
                    deployOpsworks(job, actionConfig, topicARN, callback);
                }
            ],
